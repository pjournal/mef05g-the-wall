...
- [Data set](https://evds2.tcmb.gov.tr/index.php?/evds/serieMarket/collapse_19/5100/DataGroup/english/bie_undnakliyetih/)
...
- Creating a functional Shiny App that shows Import/Export/Empty Entry Information with multiple filters
