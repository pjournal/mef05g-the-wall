...
```{r code chunk 1,fig.width=9, fig.height=4, echo = TRUE, eval = TRUE, warning=FALSE, warning=FALSE}
...
wordcloud2(data=ImportFreq, size=0.5)
...
```{r code chunk 2,fig.width=9, fig.height=4, echo = TRUE, eval = TRUE, warning=FALSE, warning=FALSE, fig.keep='all'}
...
wordcloud2(data=ExportFreq, size=0.5)
